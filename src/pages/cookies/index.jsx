...
const cookies = () => {
    return (
        ...
        <div className="mt-4 p-4 max-w-4xl mx-auto bg-white dark:bg-dark-2 shadow-md rounded-lg cookiescontent">

        <h1 className="pb-2 border-b-2">Cookie Policy</h1>
        
        <h2>Introduction</h2>
        <p>This Cookie Policy explains how OwldoTask ("we," "us," or "our") uses cookies and similar technologies on our website. This policy provides you with clear and comprehensive information about the cookies we use and the purposes for which we use them in compliance with EU regulations (including the GDPR and ePrivacy Directive) and international privacy laws.</p>
...
The cookies used by Google include, among others: SID, HSID, SSID, SAPISID, APISID, NID, AEC, and secure variants such as _Secure-1PAPISID, etc. You can view Google’s cookie policy here.
  ...
  <div class="grid-row p-2 border-b-2 dark:bg-dark-1">
    ...
    <div class="grid-cell" data-label="Expiry:">Up to 2 years</div>
        ...
        <p>Our website includes content and services from third parties that may place cookies on your device. These include:</p>
        ...
        <p>Please note that we do not have control over cookies set by these third parties. We recommend reviewing their respective privacy and cookie policies for more information.</p>
        
        <h2>Cookie Management</h2>
        
        <h3>Your Consent</h3>
        <p>When you first visit our website, you will be presented with a cookie banner giving you the option to accept or decline non-essential cookies. You can change your preferences at any time by clicking on the "Cookie Preferences" link at the bottom of our website.</p>
        
        <h3>Browser Settings</h3>
        <p>Most web browsers allow some control of cookies through browser settings. To find out more about cookies, including how to see what cookies have been set and how to manage and delete them, visit <a href="http://www.allaboutcookies.org" className="text-blue-600 hover:underline">www.allaboutcookies.org</a>.</p>
        ...
        <p>Please note that by disabling certain cookies, you may not be able to use all the features of our website.</p>
        
        <h2>Ad-Blocker Detection</h2>
        <p>Our website uses technology to detect if you are using an ad-blocker. This detection is necessary to inform authenticated users about our advertising-supported business model. The ad-blocker detection does not collect personal information but identifies if ad-blocking software is being used.</p>
        
        <h2>Updates to This Cookie Policy</h2>
        <p>We may update this Cookie Policy from time to time to reflect changes in technology, regulation, or our business practices. Any changes will be posted on this page and, where appropriate, notified to you by email or a prominent notice on our website.</p>
        
        <h2>Contact Us</h2>
        <p>If you have any questions about our use of cookies or this Cookie Policy, please contact us at:</p>
        <p>Email: <strong>info@owldotask.com</strong></p>
