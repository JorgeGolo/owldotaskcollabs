  ...
  switch (goal) {
    case "completion":
      return (
        ...
        <div className="text-1xl mb-2">
          ...
          <span className="font-bold font-bebas inline-flex items-center">{score} <FaFeather className="w-4 h-4 text-yellow-500 ml-1" /></span>
          <span> feathers</span>
        </div>
        </>
      );
    case "perfectScore":
      return (
        ...
        <div className="text-1xl mb-2">
          ...
          <span className="font-bold font-bebas inline-flex items-center">+ 5 <FaFeather className="w-4 h-4 text-yellow-500 ml-1" /></span>
          <span> feathers</span>
        </div>
        </>
      );
    ...
    default:
      return (
        <>
        <div className="text-1xl mb-2">
          <span>You've won </span><span className="font-bold font-bebas inline-flex items-center">
            {score} <FaFeather className="w-4 h-4 text-yellow-500 ml-1" />
            </span><span> feathers</span>
        </div>
        </>
      );
  }
...
const Popup = ({ isOpen, onClose, score, goal }) => {
  ...
  return (
    <Modal isOpen={isOpen} onRequestClose={onClose} style={modalStyles} contentLabel="Test results">
      <div className="text-1xl mb-2">
